...
public class GrindingRecipeCategory implements ISkillRecipeCategory<IGrindingRecipe>{
	public static final ResourceLocation Uid = new ResourceLocation(ProfessionsMod.MODID, "grinding_crafting");
	...
	public GrindingRecipeCategory(IGuiHelper helper) {
		this.localizedName = I18n.get("container.professionsmod.grindingcrafting");
		...
		this.icon = helper.createDrawableIngredient(new ItemStack(ItemInit.MORTARANDPESTLE.get().asItem()));
	}
	@Override
	...
	@Override
	public Class<? extends IGrindingRecipe> getRecipeClass() {
	...
	@Override
	public void setIngredients(IGrindingRecipe recipe, IIngredients ingredients) {
		ingredients.setInputIngredients(recipe.getIngredients());
		ingredients.setOutput(VanillaTypes.ITEM, recipe.getResultItem());
	}

	@Override
	public void setRecipe(IRecipeLayout recipeLayout, IGrindingRecipe recipe, IIngredients ingredients) {
	...
	@Override
	public void draw(IGrindingRecipe recipe, MatrixStack matrixStack, double mouseX, double mouseY) {
