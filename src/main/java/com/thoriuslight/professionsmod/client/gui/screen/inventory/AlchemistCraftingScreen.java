...
public class AlchemistCraftingScreen extends ContainerScreen<AlchemistCraftingContainer> {
	private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation("textures/gui/container/crafting_table.png");

	public AlchemistCraftingScreen(AlchemistCraftingContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
