...
public class AlchemyCraftingResultSlot extends Slot{
	private final CraftingInventory craftMatrix;
	private final PlayerEntity player;
	private int amountCrafted;

	public AlchemyCraftingResultSlot(PlayerEntity player, CraftingInventory craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	...
	public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
		...
		NonNullList<ItemStack> nonnulllist = thePlayer.level.getRecipeManager().getRemainingItemsFor(RecipeSerializerInit.ALCHEMY_TYPE, this.craftMatrix, thePlayer.level);
