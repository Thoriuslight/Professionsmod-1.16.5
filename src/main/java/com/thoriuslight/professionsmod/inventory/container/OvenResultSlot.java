...
public class OvenResultSlot extends Slot {
	...
	public OvenResultSlot(PlayerEntity player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition) {
	...
	protected void checkTakeAchievements(ItemStack stack) {
		...
		if (!this.player.level.isClientSide && this.container instanceof OvenControllerTileEntity) {
