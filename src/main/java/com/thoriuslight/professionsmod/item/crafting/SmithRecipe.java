...
public class SmithRecipe implements ISmithRecipe{
	...
	public static Map<ResourceLocation, ISmithRecipe> recipeList = Collections.emptyMap();
	
	public SmithRecipe(ResourceLocation id, int recipeWidthIn, int recipeHeightIn, NonNullList<Ingredient> recipeItemsIn, ItemStack output, int requirement){
